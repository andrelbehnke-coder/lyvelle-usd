...
export const CATEGORIAS = [
  ...
  { id: "preco_desconto", rotulo: "Preço / por que barato",
    re: /(\bwhy (is it|so) (cheap|low|179)|what'?s the catch|too good to be true|too cheap|how much|what does it cost|\bprice\b|\$ ?\d|\bdiscount\b|\b70% ?off\b|why not 597)/i },
