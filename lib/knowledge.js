...
export const FACTS = [
  // --- oferta ---
  "Price today is $179. Regular price is $597. That is 70% off and saves $418.",
...
The invitation usually carries three ideas, and you pick which ones fit the moment:
  ...
  - the 70% off, or the $179, holds while today's stock does
...
Good closings, as calibration only - do not reuse these:
  "If you want to lock in the 70% off today, the button's right below. Order comes
  ...
  "It's sat there at $179 whenever you're ready. I'll be watching for the order."
...
export const FALLBACK = [
  { re: /(real|genuine|authentic|fake|knock ?off|replica|original)/i, a: ["It's a genuine Dyson, not a replica and not a refurbished unit.", "It ships sealed in the original Dyson box with the serial number intact, so you can register it on Dyson's own site the day it lands.", "And if anything about it isn't right, you have 30 days to send it back and the full 2-year Dyson warranty on top.", "If you want it locked in at $179 today, the button's just below. [[CHECKOUT]]"] },
  ...
  { re: /(return|refund|money back|send.*back)/i, a: ["30 days, no questions and no restocking fee.", "We arrange the collection, so it doesn't cost you anything to send it back.", "Nothing to lose either way. It's sat there at $179 when you want it. [[CHECKOUT]]"] },
  ...
  { re: /(price|cost|how much|\$)/i, a: ["It's $179 today, down from $597.", "The $69 styling kit comes free with it and shipping's included.", "Button's below if you want to grab it before stock runs. [[CHECKOUT]]"] },
